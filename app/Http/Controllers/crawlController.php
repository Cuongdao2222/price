...
class crawlController extends Controller
{
    ...
    public function crawl_web(Request $request)
    {
        ...
        $ar = [
            ...
            ['name_url'=>'https://manhnguyen.com.vn', 'site'=>'https://manhnguyen.com.vn/tim-kiem?q='.$model, 'name'=>'.product-name', 'price'=>'.product_item strong', 'remove'=>'.old_price'],
        ...
        foreach ($ar as $key=>  $value) {
            ...
            $info[$key]['name'] = $name;
            $info[$key]['price'] = $price;
            

        }
        
        return view('frontend.checkprice', compact('info'));
