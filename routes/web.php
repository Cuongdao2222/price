...
Route::get('/',function(){
    ...
    // $img->insert(public_path('images/logo.png'), 'bottom-left', -10, 0);
   
    // $img->save(public_path('images/main-new.jpg')); 
   
    // dd('saved image successfully.');
        return view('frontend.checkprice');

});

Route::get('/search-model', 'crawlController@crawl_web')->name('search-model');
